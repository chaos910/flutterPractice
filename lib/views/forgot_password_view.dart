...
import 'package:flutterpractice/util/password_reset_email_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                "We could not process your request. Make sure you are registered user or contact help");
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text("Enter your email for us to send you an email link"),
              TextField(
